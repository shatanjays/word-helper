...
export const legalPages = [
  {
    ...
    bodyHtml: [
      ...
      <ul>
        ...
        <li><strong><a href="/tools/word-choice-helper/">Word Choice Helper</a></strong> — suggests clearer, tone-matched alternatives for weak or overused words in your sentence.</li>
        <li><strong><a href="/tools/clarity-checker/">Grammar-Lite Clarity Checker</a></strong> — catches common clarity issues like doubled words, overlong sentences, and filler words. It may miss grammar errors; it is not an editor replacement.</li>
        <li><strong><a href="/tools/tone-checker/">Tone Checker</a></strong> — reads visible signals in your text to estimate its broad tone: formal, casual, friendly, direct, or promotional.</li>
        <li><strong><a href="/tools/readability-checker/">Readability Checker</a></strong> — measures sentence length, complex words, and reading time, with an estimated reading-ease score.</li>
        <li><strong><a href="/tools/repeated-word-finder/">Repeated Word Finder</a></strong> — counts the words you repeat most, with a stop-word toggle and alternative suggestions.</li>
      </ul>`,
  ...
  },
  {
    ...
    bodyHtml: [
      ...
      <p>Word Helper provides a focused collection of word and writing tools for writing support, vocabulary learning, word game play, spelling pattern discovery, and creative word exploration — including Word Unscramble, Anagram Solver, Rhyme Finder, Syllable Counter, Prefix Finder, Suffix Finder, Word Finder, Synonym Finder, Antonym Finder, Word Counter, Random Word Generator, and a set of lightweight writing clarity helpers (Word Choice Helper, Clarity Checker, Tone Checker, Readability Checker, and Repeated Word Finder). The site also includes searchable word pages, curated word lists, guided learning articles, and vocabulary quizzes.</p>
  ...
  },
  {
    ...
    bodyHtml: [
      ...
      `<h2>July 2026</h2>
      <ul>
        <li><strong>Five writing clarity tools added:</strong> Word Choice Helper, Grammar-Lite Clarity Checker, Tone Checker, Readability Checker, and Repeated Word Finder — all lightweight, rule-based, and running entirely in your browser. Total tools now: 16.</li>
